...
CATALOG += [
    ...
    mutant(
        ...
        "_BOUND_MAX = 2**53 - 1",
        "_BOUND_MAX = 2**63 - 1",
        [PY_RUNNER_FAILS, "FAIL [refused_slot_bound_past_2_53_1] field=validate.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_slot_bound_past_2_53_1] field=validate.expect"],
    ),
    mutant(
        ...
        [PY_RUNNER_FAILS, "FAIL [refused_budget_negative_charge] field=charge.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_budget_negative_charge] field=charge.expect"],
    ),
    ...
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_slot_spec_without_a_name] field=validate.expect"],
    ),
    mutant(
        ...
        [PY_RUNNER_FAILS, "FAIL [refused_slot_spec_without_a_name] field=validate.expect"],
    ),
    mutant(
    ...
    mutant(
        ...
        "    if not 0 <= value < _BOUND_MAX:",
        [PY_RUNNER_FAILS, "FAIL [text_max_length_at_the_largest_allowed_bound_accepted] field=validate.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [text_max_length_at_the_largest_allowed_bound_accepted] field=validate.expect"],
    ),
    mutant(
        ...
        [PY_RUNNER_FAILS, "FAIL [refused_budget_boolean_charge] field=charge.expect"],
    ),
    mutant(
        ...
        "    if isinstance(value, bool) or not isinstance(value, (int, float)):",
        "    if not isinstance(value, (int, float)):",
        [PY_RUNNER_FAILS, "FAIL [refused_slot_boolean_bound] field=validate.expect"],
    ),
    ...
    mutant(
        ...
        [PY_RUNNER_FAILS, "FAIL [refused_budget_negative_cap] field=charge.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_budget_negative_cap] field=charge.expect"],
    ),
    mutant(
        ...
        "        if value != value:",
        [PY_RUNNER_FAILS, "FAIL [refused_budget_fractional_charge] field=charge.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_budget_fractional_charge] field=charge.expect"],
    ),
    mutant(
        ...
        "    if not 0 <= value <= _LEDGER_MAX:",
        "    if not 0 <= value:",
        [PY_RUNNER_FAILS, "FAIL [refused_budget_past_2_63_1_charge] field=charge.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_budget_past_2_63_1_charge] field=charge.expect"],
    ),
    mutant(
        ...
        "        if not value.is_integer():",
        "        if value != value:",
        [PY_RUNNER_FAILS, "FAIL [refused_slot_fractional_bound] field=validate.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_slot_fractional_bound] field=validate.expect"],
    ),
    mutant(
        ...
        "    if not isinstance(name, str):",
        "    if name is None:",
        [PY_RUNNER_FAILS, "FAIL [refused_slot_spec_with_a_non_string_name] field=validate.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_slot_spec_with_a_non_string_name] field=validate.expect"],
    ),
    Mutant(
    ...
    mutant(
        ...
        [PY_RUNNER_FAILS, "FAIL [refused_budget_nan_charge] field=charge.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_budget_nan_charge] field=charge.expect"],
    ),
    mutant(
        ...
        "        if not value.is_integer():\n",
        '        if value != value or value in (float("inf"), float("-inf")):\n            return None\n        if not value.is_integer():\n',
        [PY_RUNNER_FAILS, "FAIL [refused_slot_nan_bound] field=validate.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_slot_nan_bound] field=validate.expect"],
    ),
    mutant(
        ...
        [PY_RUNNER_FAILS, "FAIL [refused_budget_fractional_charge] field=charge.raised"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_budget_fractional_charge] field=charge.raised"],
    ),
    mutant(
        ...
        '        shard: ["1/4", "2/4", "3/4"]\n',
        ["the shards the workflow names (1/4,2/4,3/4) do not hold every catalog mutant exactly once", "are not 1/4..4/4 once each"],
    ),
    mutant(
        "ci: each matrix entry reaches --shard as it is",
        ".github/workflows/check.yml",
        "        run: python3 scripts/mutants.py --shard ${{ matrix.shard }}\n",
        "        run: python3 scripts/mutants.py --shard 1/4\n",
    ...
    mutant(
        ...
        ["the shards the workflow names (1/4,2/4,3/4,4/4) do not hold every catalog mutant exactly once"],
    ),
    ...
    mutant(
        ...
        "        if not value.is_integer():\n",
        '        if value == float("-inf"):\n            return 0\n        if not value.is_integer():\n',
        [PY_RUNNER_FAILS, "FAIL [refused_budget_negative_infinite_charge] field=charge.expect"],
    ),
    mutant(
        ...
        [TS_RUNNER_FAILS, "FAIL [refused_budget_negative_infinite_charge] field=charge.expect"],
    ),
    mutant(
    ...
    # --- a refusal is a fixture outcome, and a refused charge changes nothing
    mutant(
        "ts budget: a refused charge changes nothing",
        "ts/budget.ts",
        '    const ms = ledger(charge.ms, "ms");\n    const tokens = ledger(charge.tokens, "tokens");\n    this.turns_used = saturatingAdd(this.turns_used, turns);\n',
        '    this.turns_used = saturatingAdd(this.turns_used, turns);\n    const ms = ledger(charge.ms, "ms");\n    const tokens = ledger(charge.tokens, "tokens");\n',
        [TS_RUNNER_FAILS, "FAIL [refused_charge_changes_nothing] field=charge.expect"],
    ),
    mutant(
        ...
        '        self.turns_used = _saturating_add(self.turns_used, turns)\n        ms = _ledger(ms, "ms")\n        tokens = _ledger(tokens, "tokens")\n',
        [PY_RUNNER_FAILS, "FAIL [refused_charge_changes_nothing] field=charge.expect"],
    ),
    mutant(
        ...
        '    this.turns_used = saturatingAdd(this.turns_used, turns);\n    this.ms_used = saturatingAdd(this.ms_used, ms);\n    const tokens = ledger(charge.tokens, "tokens");\n',
        [TS_RUNNER_FAILS, "FAIL [refused_charge_with_the_last_field_bad_changes_nothing] field=charge.expect"],
    ...
    mutant(
        ...
        '        self.turns_used = _saturating_add(self.turns_used, turns)\n        self.ms_used = _saturating_add(self.ms_used, ms)\n        tokens = _ledger(tokens, "tokens")\n',
        [PY_RUNNER_FAILS, "FAIL [refused_charge_with_the_last_field_bad_changes_nothing] field=charge.expect"],
        # the second amount is still read before anything is added, so that case holds
        ["FAIL [refused_charge_changes_nothing]"],
    ),
    mutant(
        "py runner: a malformed fixture is never read as a refusal",
        "py/run_fixtures.py",
        "        charge = _decode_fixture_value(encoded)\n        result = _or_refused(lambda charge=charge: budget.charge(**charge))\n",
        "        result = _or_refused(\n            lambda encoded=encoded: budget.charge(**_decode_fixture_value(encoded))\n        )\n",
        ["python did not refuse a malformed literal where a refusal is expected"],
    ),
